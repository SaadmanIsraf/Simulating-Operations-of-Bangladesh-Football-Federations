...
public class TrainingScheduleManager {
    ...
    private static final List<TrainingSchedule>
            trainingScheduleList =
            new ArrayList<>();

    private static final String FILE_NAME =
            "training-schedules.bin";

    static {
        loadFromFile();
    }

    public static List<TrainingSchedule>
    getTrainingScheduleList() {

        return trainingScheduleList;
    }

    public static void addTrainingSchedule(
            TrainingSchedule trainingSchedule) {

        trainingScheduleList.add(
                trainingSchedule
        );
    }

    public static void removeTrainingSchedule(
            TrainingSchedule trainingSchedule) {

        trainingScheduleList.remove(
                trainingSchedule
        );
    }
    ...
    private static void loadFromFile() {
        ...
        try (ObjectInputStream inputStream =
            ...
            System.out.println(
                    "Could not load training schedule data."
            );
        }
    }
    ...
    public static void saveToFile() {
        ...
        try (ObjectOutputStream outputStream =
            ...
            System.out.println(
                    "Training schedules saved successfully."
            );
            ...
            System.out.println(
                    "Could not save training schedule data."
            );
        }
    }
}