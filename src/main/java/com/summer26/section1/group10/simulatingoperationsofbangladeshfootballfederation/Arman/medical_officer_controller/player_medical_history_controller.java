...
public class player_medical_history_controller
{
    ...
    public void initialize() {
        ...
        injury_report_column.setCellValueFactory(
                new PropertyValueFactory<>("injuryReport")
        );
        ...
        treatment_plans_column.setCellValueFactory(
                new PropertyValueFactory<>("treatmentPlan")
        );

        matchday_incident_column.setCellValueFactory(
                new PropertyValueFactory<>("matchDayIncident")
        );
    ...
    public void search_button_on_action(ActionEvent actionEvent) {
        ...
        for (InjuryReport injuryReport :
            ...
            if (injuryReport.getPlayerId() == playerId) {
                ...
                MedicalHistoryRecord historyRecord =
                        new MedicalHistoryRecord(
                                playerId,
                                foundPlayer.getName(),
                ...
                player_mdecial_history_tableview
                        .getItems()
                        .add(historyRecord);
        ...
        if (!recordFound) {
            ...
            TreatmentPlan treatmentPlan =
                    getFirstTreatmentPlan(playerId);

            MatchDayMedicalIncident incident =
                    getFirstIncident(playerId);
        ...
        if (!recordFound) {
            showAlert(
                    ...
                    "No Record Found",
                    "No medical history found for this Player ID."
            );
            return;
        }
