...
/**
 * Generic helper for persisting objects to/from binary (.bin) files.
 * Works with any Serializable domain class (Player, Club, Match, Referee, etc.).
 */
